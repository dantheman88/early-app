...
const styles = {
  ...
  navSubtitle: { opacity: 0.6, fontSize: 12, marginTop: 2 },
  navButton: {
    padding: "6px 12px",
    borderRadius: 20,
  ...
  title: { fontSize: 26, marginBottom: 8, fontWeight: "bold" },
  gradient: {
    background: "linear-gradient(90deg, cyan, violet)",
    WebkitBackgroundClip: "text",
    color: "transparent",
  },
  subtitle: { opacity: 0.8, fontSize: 14, marginBottom: 16 },
  ...
  cardTitle: { fontSize: 20, marginBottom: 8, fontWeight: "600" },
